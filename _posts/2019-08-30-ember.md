...
The method `query()` is the first one called. Then it's picks required parameters and pass them along with return value of the ajax call. We do not introduce side effects, and the method is pure and functional. 
